...
const getReactNativeVersion = projectRoot => {
    var _require;
    /*projectRoot 的值：/Users/yuzhiqiang/workspace/RN/personal/RNProjectAnalysis/node_modules/react-native*/
    console.log(`从${projectRoot}的package.json中获取version属性的值，也就是RN的版本 \n `);
...
/**
 * 获取当前项目的react-native版本并解析为Semver
 * @param projectRoot
 * @returns {undefined|*}
 */

...
/**
 * 获取包依赖的目录，从给定的目录开始，向外移动，通过所有父目录。
 * 包依赖项存在于'node_modules/[`scope`]/[`name`]`。
 * 也就是说依赖名要跟node_modules下的目录名一致
 * @param ref 包依赖项引用
 * @param options 控制搜索的选项
 * @returns {*|string}
 */
function findPackageDependencyDir(ref, options) {
    ...
    console.log(`获取的包依赖目录结果 packageDir: `, packageDir)
